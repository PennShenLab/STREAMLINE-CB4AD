...
def job(experiment_path,training,rep_data_path,data_path):
    ...
    ls2 = ars_dic[87:105]   # ML modeling algorithms
    ls3 = ars_dic[105:108]  # primary metric - ExportHyperparemterSweepPLot  [132:150]
    ...
    for n in range(len(ds)):
        ...
        if eval(training):
            analy_report.image(experiment_path+'/'+ds[n]+'/model_evaluation/residualPlot/'+'residual_distrib_all_algorithms.png', 1, 120, 200, 160)
        ...
        if eval(training):
            analy_report.image(experiment_path+'/'+ds[n]+'/model_evaluation/residualPlot/'+'actual_vs_predict_all_algorithms.png', 1, 10, 200, 90)
            analy_report.image(experiment_path+'/'+ds[n]+'/model_evaluation/residualPlot/'+'probability_train_residual_all_algorithms.png', 1, 90, 100, 90)
            analy_report.image(experiment_path+'/'+ds[n]+'/model_evaluation/residualPlot/'+'probability_test_residual_all_algorithms.png', 110, 90, 100, 90)
