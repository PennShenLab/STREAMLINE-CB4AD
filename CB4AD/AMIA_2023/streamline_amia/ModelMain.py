...
def main(argv):
    ...
    parser.add_argument('--do-EN', dest='do_EN', type=str, help='run elastic net modeling',default='True')
    ...
    parser.add_argument('--do-CGB', dest='do_CGB', type=str,help='run CatBoost modeling',default='True')
    ...
    parser.add_argument('--do-KNN', dest='do_KNN', type=str, help='run k-nearest neighbors classifier modeling',default='True')
    parser.add_argument('--do-GP', dest='do_GP', type=str, help='run genetic programming symbolic classifier modeling',default='True')
    ...
    algInfo['Elastic Net'] = [True,'EN','silver']
    ...
    algInfo['K-Nearest Neighbors'] = [True,'KNN','chocolate']
    ...
    if not options.do_EN == 'None':
        algInfo['Elastic Net'][0] = eval(options.do_EN)
    ...
    if not options.do_KNN == 'None':
        algInfo['K-Nearest Neighbors'][0] = eval(options.do_KNN)
    ...
    if not options.do_check and not options.do_resubmit: #Run job submission
        ...
        metadata['K-Nearest Neighbors'] = str(algInfo['K-Nearest Neighbors'][0])
